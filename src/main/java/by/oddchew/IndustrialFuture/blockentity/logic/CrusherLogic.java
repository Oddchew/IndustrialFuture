...
public class CrusherLogic {
    ...
    private Item SolidToDust(ItemStack solid){
        ...
        if(item == BlockItems.SULFUR_ORE.get() || item == BlockItems.DEEPSLATE_SULFUR_ORE.get()){
            return ModItems.SULFUR_DUST.get();
        }
        return null;
    }
}
