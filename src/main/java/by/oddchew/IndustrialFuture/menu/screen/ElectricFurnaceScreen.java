...
public class ElectricFurnaceScreen extends AbstractContainerScreen<ElectricFurnaceMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MODID, "textures/gui/electric_furnace_gui.png");
    ...
    public ElectricFurnaceScreen(ElectricFurnaceMenu menu, Inventory playerInventory, Component title) {
        ...
        this.playerInventory = playerInventory;
            //IndustrialFuture.LOGGER.debug("ElectricFurnaceScreen initialized for {}", title.getString());
    }
    ...
    protected void renderBg(PoseStack poseStack, float partialTick, int mouseX, int mouseY) {
            ...
            this.blit(poseStack,
                    ...
                    14, energyScaled);
            // Отрисовка индикатора плавления
            int crushProgress = this.menu.getBlockEntity().getProgressScaled();
            //IndustrialFuture.LOGGER.debug("crushProgress = " + crushProgress);
            this.blit(poseStack,
                    x + 57, y + 37 + (14 - crushProgress),
                    176, 14 - crushProgress,
                    13, crushProgress);
    }
