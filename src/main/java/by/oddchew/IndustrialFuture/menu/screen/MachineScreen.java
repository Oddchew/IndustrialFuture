...
public class MachineScreen extends AbstractContainerScreen<MachineMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MODID, "textures/gui/machine_gui.png");
    ...
    protected void renderBg(PoseStack poseStack, float partialTick, int mouseX, int mouseY) {
        ...
        // Отрисовка индикатора горения
        int burnProgress = this.menu.getBlockEntity().getBurnProgressScaled();
        this.blit(poseStack,
                x + 57, y + 37 + (14 - burnProgress),
                176, 14 - burnProgress,
                13, burnProgress);

        //IndustrialFuture.LOGGER.info("Energy: {}/{}, Scaled: {}", energyStored, maxEnergy, energyScaled);
        //IndustrialFuture.LOGGER.info("Burn progress: {}", burnProgress);
    }
